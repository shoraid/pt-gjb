    ...
    <form action="{{ route('cms.notes.update', $note->id) }}" method="post">
      ...
      <div class="d-flex flex-column gap-4">
        ...
        <x-forms.label :label="__('app.notes.is_public')" name="is_public" required>
          <div>
            <x-forms.radio :label="__('app.general.yes')" name="is_public" value="1" inline :checked="old('is_public', $note->is_public) == '1'" />
            <x-forms.radio :label="__('app.general.no')" name="is_public" value="0" inline :checked="old('is_public', $note->is_public) == '0'" />
          </div>
        </x-forms.label>
