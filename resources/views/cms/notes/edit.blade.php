    ...
    <form action="{{ route('cms.notes.update', $note->id) }}" method="post">
      ...
      <div class="d-flex flex-column gap-4">
        ...
        <x-forms.label :label="__('app.notes.archived')" name="archived" required>
          <div>
            <x-forms.radio :label="__('app.general.yes')" name="archived" value="1" inline :checked="old('archived', $note->archived) == '1'" />
            <x-forms.radio :label="__('app.general.no')" name="archived" value="0" inline :checked="old('archived', $note->archived) == '0'" />
          </div>
        </x-forms.label>
